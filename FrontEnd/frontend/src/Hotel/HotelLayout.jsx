...
const HotelLayout = () => {
    ...
    const menuItems = [
        { name: "Dashboard", path: "hotelDashboard", icon: LayoutDashboard },
        { name: "Bookings", path: "hotelBookings", icon: CalendarCheck },
        { name: "All Rooms", path: "allRooms", icon: BedDouble },
        { name: "Profile", path: "hotelProfile", icon: UserCircle },
    ];
    ...
    const getPageTitle = () => {
        if (location.pathname.includes("hotelDashboard")) return "Overview";
        if (location.pathname.includes("hotelBookings")) return "Reservations";
        if (location.pathname.includes("allRooms")) return "Room Inventory";
        if (location.pathname.includes("hotelProfile")) return "Hotel Profile";
        ...
        <div className="flex h-screen bg-gray-50 font-['Inter',sans-serif] text-gray-800 overflow-hidden selection:bg-blue-600 selection:text-white">
            ...
            <aside className="w-64 bg-white border-r border-gray-200 flex-col shrink-0 hidden lg:flex shadow-2xs z-20 relative">
                <div className="px-6 py-7 border-b border-gray-100 flex flex-col items-start gap-3">
                    <div className="flex items-center cursor-pointer group" onClick={() => navigate("/hotel/hotelDashboard")}>
                        <img
                            src={logo}
                            alt="AuraStays"
                ...
                <div className="fixed inset-0 z-50 lg:hidden flex">
                    ...
                    <aside className="w-64 bg-white h-full shadow-2xl relative z-10 flex flex-col animate-in slide-in-from-left-4 duration-200">
                        <div className="px-6 py-7 border-b border-gray-100 flex flex-col items-start gap-3 relative">
                            <div className="flex items-center cursor-pointer group" onClick={() => { setMobileMenuOpen(false); navigate("/hotel/hotelDashboard"); }}>
                                <img
                                    src={logo}
                                    alt="AuraStays"
                                    className="h-20 w-auto object-contain invert opacity-90 transition-transform duration-300 group-hover:scale-105"
                                ...
                                {notificationsOpen && ReactDOM.createPortal(
                                    ...
                                    >
                                        ...
                                        <div className="pt-2 px-4 border-t border-gray-100 text-center">
                                            <button
                                                onClick={() => { setNotificationsOpen(false); navigate("hotelBookings"); }}
