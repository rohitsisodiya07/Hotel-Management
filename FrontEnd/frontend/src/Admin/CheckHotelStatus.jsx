                    ...
                    ================================================= */}
                        {hotel && (
                            <div className="border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
                                ...
                                {/* RESULT HEADER */}
                                <div className="p-5 bg-gray-50 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0">
                                    <div>
                                    ...
                                    <span
                                        className={`px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider border w-fit ${STATUS_STYLES[status] || "bg-gray-100 text-gray-700 border-gray-200"}`}
                                    >
                                        {status}
                                    </span>
                                </div>
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="rounded-xl border border-gray-100 overflow-hidden text-sm">
                                        <div className="px-4 py-3 bg-gray-50/60 border-b border-gray-100 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                                        ...
                                        <div className="px-4 py-3 border-b border-gray-100 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                                            <span className="text-[10px] uppercase tracking-wider font-bold text-gray-400">
                                                Email
                                            </span>
                                            <span className="text-xs font-semibold text-gray-900 break-all sm:text-right">
                                                {hotel.hotelEmail}
                                            </span>
                                        </div>
                                        ...
                                        <div className="px-4 py-3 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                                            <span className="text-[10px] uppercase tracking-wider font-bold text-gray-400">
                                                Submitted On
                                            </span>
                                    ...
                                    {status === "Rejected" && hotel.remark && (
                                        <div className="mt-4 rounded-xl bg-rose-50 border border-rose-200 p-4">
                                            <div className="flex items-start gap-3">
                                                <AlertCircle size={17} className="text-rose-600 mt-0.5 shrink-0" />
                                                <p className="text-xs leading-5 text-rose-700">
                                                    <span className="font-bold">Rejection Remark:</span> {hotel.remark}
                                                </p>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    <button
                                        ...
                                        className="w-full mt-5 h-[48px] rounded-xl bg-gray-900 hover:bg-gray-800 text-white text-[13px] font-bold transition-all shadow-md"
                                    >
